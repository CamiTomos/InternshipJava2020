...
public class TagControllerTest {
    ...
    void whenHandleInsertTag_givenTagDTO_returnResponseEntity() throws Exception {
        Tag insertedTag = new Tag(1, "test insert");
        when(tagService.insertTag(any(Tag.class))).thenReturn(insertedTag);
    ...
    void whenHandleFindAllTags_given_returnResponseEntity() throws Exception {
        List<Tag> dtoList = new ArrayList<>(5);
        dtoList.add(new Tag(1, "first"));
        dtoList.add(new Tag(2, "second"));
